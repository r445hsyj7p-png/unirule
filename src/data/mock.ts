...
export const mockNotifications = [
  { id: '1', title: 'Kritische Schwachstelle erkannt', body: 'CVE-2024-1234 auf fw-core-01 gefunden', severity: 'critical', read: false, time: new Date(Date.now() - 5 * 60000) },
  { id: '2', title: 'Ungewöhnlicher Traffic', body: 'IoT-Zone → Corp LAN: 847 Verbindungen/min', severity: 'high', read: false, time: new Date(Date.now() - 22 * 60000) },
  { id: '3', title: 'Policy-Verletzung', body: 'Gerät 192.168.30.45 überschreitet erlaubte Ports', severity: 'medium', read: false, time: new Date(Date.now() - 67 * 60000) },
  { id: '4', title: 'UniFi Poller Sync', body: 'Letzte Synchronisierung erfolgreich (247 Geräte)', severity: 'info', read: true, time: new Date(Date.now() - 120 * 60000) },
  { id: '5', title: 'Neues Gerät erkannt', body: 'MAC: 00:1A:2B:3C:4D:5E in VLAN 20', severity: 'low', read: true, time: new Date(Date.now() - 240 * 60000) },
]
...
export const mockZoneDistribution = [
  { name: 'Corp LAN', value: 42, color: '#3b82f6' },
  { name: 'DMZ', value: 18, color: '#f59e0b' },
  { name: 'IoT', value: 15, color: '#10b981' },
  { name: 'Guest', value: 12, color: '#8b5cf6' },
  { name: 'Management', value: 8, color: '#ef4444' },
...
export const mockThreats = [
  ...
  { id: 't7', title: 'IoT-Gerät ohne VLAN-Isolation', description: 'HP-Drucker kommuniziert direkt mit Corp-LAN-Hosts. Verstößt gegen Segmentierungsrichtlinie.', severity: 'medium', status: 'open', device: 'printer-floor2', zone: 'IoT Segment', timestamp: new Date(Date.now() - 12 * 3600000), category: 'Policy Violation', cve: null },
...
export const mockPolicySuggestions = [
  {
    id: 'p1',
    title: 'IoT → Corp LAN vollständig blockieren',
    description: 'Das IoT-Segment hat aktuell Zugriff auf Corp-LAN-Ressourcen. Nach Zero-Trust-Prinzip muss dieser Pfad vollständig gesperrt werden.',
    impact: 'critical',
    effort: 'low',
    status: 'pending',
    category: 'Segmentierung',
    affectedZones: ['IoT Segment', 'Corp LAN'],
    suggestedRule: 'DENY all from 192.168.30.0/24 to 10.0.10.0/24',
    reasoning: 'Lateral-Movement-Angriff erkannt. IoT-Geräte benötigen keinen Zugang zum Corp-Netzwerk.',
    source: 'batfish-analyse',
  },
  {
    id: 'p2',
    title: 'MFA für Management-Zugriff erzwingen',
    description: 'Zugriff auf das Management-VLAN (50) erfolgt aktuell ohne Multi-Faktor-Authentifizierung.',
    impact: 'high',
    effort: 'medium',
    status: 'pending',
    category: 'Authentifizierung',
    affectedZones: ['Management'],
    suggestedRule: 'REQUIRE mfa for VLAN 50 access from Corp LAN',
    reasoning: 'Management-Zugang ohne MFA verletzt Zero-Trust-Grundsätze.',
    source: 'policy-engine',
  },
  {
    id: 'p3',
    title: 'OT/SCADA Air-Gap simulieren',
    description: 'Das SCADA-Netz ist erreichbar aus dem Corp LAN. Nur dedizierte Jump-Hosts sollten Zugriff haben.',
    impact: 'critical',
    effort: 'high',
    status: 'in_review',
    category: 'Segmentierung',
    affectedZones: ['OT/SCADA', 'Corp LAN'],
    suggestedRule: 'ALLOW from 10.0.50.5 (jumphost) to 192.168.60.0/24; DENY all others',
    reasoning: 'Windows 7 EOL + direkter LAN-Zugang = kritisches Risiko für OT-Infrastruktur.',
    source: 'batfish-analyse',
  },
  {
    id: 'p4',
    title: 'TLS 1.2 Minimum erzwingen',
    description: 'Mehrere Geräte verwenden TLS 1.0/1.1 oder kein TLS. Minimum TLS 1.2 ist Pflicht.',
    impact: 'high',
    effort: 'medium',
    status: 'pending',
    category: 'Verschlüsselung',
    affectedZones: ['IoT Segment', 'DMZ'],
    suggestedRule: 'DENY TLS < 1.2 on all zones; BLOCK HTTP on IoT VLAN 30',
    reasoning: 'Kameradaten werden unverschlüsselt übertragen. TLS 1.0/1.1 als kompromittiert bekannt.',
    source: 'ntopng-scan',
  },
  {
    id: 'p5',
    title: 'DNS-Resolver auf interne Server beschränken',
    description: 'Workstations können externe DNS-Resolver direkt anfragen. Nur interne Resolver erlauben.',
    impact: 'medium',
    effort: 'low',
    status: 'approved',
    category: 'DNS-Sicherheit',
    affectedZones: ['Corp LAN'],
    suggestedRule: 'ALLOW UDP/TCP 53 only to 10.0.10.1; DENY all other DNS',
    reasoning: 'DNS-Tunneling-Verdacht erkannt. Zentrale Resolver ermöglichen Logging und Filterung.',
    source: 'ntopng-scan',
  },
  {
    id: 'p6',
    title: 'Mikrosegmentierung Server Farm',
    description: 'Server kommunizieren untereinander ohne Einschränkung. Least-Privilege-Kommunikation einführen.',
    impact: 'medium',
    effort: 'high',
    status: 'pending',
    category: 'Mikrosegmentierung',
    affectedZones: ['Server Farm'],
    suggestedRule: 'DENY intra-zone traffic; ALLOW only documented service ports',
    reasoning: 'East-West-Traffic ohne Filterung ermöglicht Ausbreitung bei Kompromittierung.',
    source: 'batfish-analyse',
  },
]
...
export const mockTopologyNodes = [
  ...
  { id: 'corp-sw', label: 'Corp SW', type: 'switch', x: 160, y: 330 },
  { id: 'dmz-sw', label: 'DMZ SW', type: 'switch', x: 310, y: 330 },
  { id: 'iot-sw', label: 'IoT SW', type: 'switch', x: 490, y: 330 },
  { id: 'mgmt-sw', label: 'Mgmt SW', type: 'switch', x: 640, y: 330 },
  { id: 'corp-ap', label: 'Corp AP', type: 'ap', x: 100, y: 430 },
  { id: 'corp-ws', label: 'Workstations\n(98 Geräte)', type: 'devices', x: 220, y: 430 },
  { id: 'dmz-srv', label: 'Web Server\n(12 Geräte)', type: 'server', x: 310, y: 430 },
  { id: 'iot-cam', label: 'Kameras/IoT\n(67 Geräte)', type: 'iot', x: 490, y: 430 },
  { id: 'mgmt-ctrl', label: 'UniFi\nController', type: 'server', x: 640, y: 430 },
]
