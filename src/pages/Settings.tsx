      ...
      <Tabs defaultValue="general">
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="text-xs text-muted-foreground">Standard (empfohlen für Security-Monitoring)</div>
                </div>
        ...
        <TabsContent value="security" className="mt-4 space-y-4">
          <Card>
            ...
            <CardContent className="space-y-4">
              {[
                { label: 'Default Deny Modus', desc: 'Alle nicht erlaubten Verbindungen blockieren', active: true },
                ...
                <div key={s.label} className="flex items-center justify-between">
                  ...
                  <div className={`w-10 h-5 rounded-full cursor-pointer flex items-center px-0.5 ${s.active ? 'bg-green-500 justify-end' : 'bg-muted justify-start'}`}>
        ...
        <TabsContent value="notifications" className="mt-4 space-y-4">
          <Card>
            <CardHeader>
              <CardTitle className="text-sm flex items-center gap-2"><Bell className="h-4 w-4" />Alert-Konfiguration</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              {[
